package com.atp.rewayti.ui.intro;
 ...
 */
 class MyViewPagerAdapter extends PagerAdapter {
    ...
    public MyViewPagerAdapter(Context systemService , int[] layouts) {
        this.context = systemService;
        this.layout = layouts;
        Log.d(TAG, "MyViewPagerAdapter: "+layout);
    }
